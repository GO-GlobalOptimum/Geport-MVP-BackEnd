...
def generate_person_type(read_db: Session = Depends(get_read_db),write_db: Session = Depends(get_write_db), user: dict = Depends(get_current_user)):
    """
    ...
    return generate_personType(read_db, get_write_db, user_model)
